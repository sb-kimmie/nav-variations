import VariationAOld from "../components/menu-v1/variation-a-old/variation-a-old";
import VariationA from "../components/menu-v1/variation-a/variation-a";
import Original from "../components/menu-v1/original/original";
import VariationB from "../components/menu-v1/variation-b/variation-b";
import VariationC from "../components/menu-v1/variation-c/variation-c";
import VariationE from "../components/menu-v1/variation-e/variation-e";
import VariationF from "../components/menu-v1/variation-f/variation-f";
import VariationG from "../components/menu-v1/variation-g/variation-g";
    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="py-10 flex flex-col gap-12">
        ...
        <section className="px-10 relative z-80">
          <div className="mb-3 flex items-center gap-3">
            <h2 className="text-xs font-bold uppercase tracking-widest text-white bg-[#2f5986] px-3 py-1 rounded-full">Variation A - Added Left Column on Desktop - White Background</h2>
          </div>
          <div className="mb-3 flex items-center gap-3">
            <h3 className="text-sm font-normal text-black">
              <strong>Differences between the Original and Variation A:</strong>
              <ul>
                ...
                <li>3. The left-column in Variation A provides context for the section, giving users immediate context for the section.</li>
                <li>4. Variation A uses horizontal and vertical lines to visually separate sections and items, whereas the Original does not have these visual separators.</li>
        ...
        <section className="px-10 relative z-50">
          <div className="mb-3 flex items-center gap-3">
            <h2 className="text-xs font-bold uppercase tracking-widest text-white bg-[#2f5986] px-3 py-1 rounded-full">Variation D - No Left Column on Desktop</h2>
          </div>
          <div className="mb-3 flex items-center gap-3">
            <h3 className="text-sm font-normal text-black">
              <strong>Differences between the Original and Variation D:</strong>
              <ul>
                <li><i>Same as Variation A, Variation B, and Variation C but without the left column.</i></li>
              </ul>
            </h3>
          </div>
          <div className="">
        ...
        <section className="px-10 relative z-40">
          <div className="mb-3 flex items-center gap-3">
            <h2 className="text-xs font-bold uppercase tracking-widest text-white bg-[#2f5986] px-3 py-1 rounded-full">Variation E   - Different Style Dropdown Headers</h2>
          </div>
          <div className="mb-3 flex items-center gap-3">
          </div>
          <div className="mb-3 flex items-center gap-3">
        ...
        <section className="px-10 relative z-30">
          <div className="mb-3 flex items-center gap-3">
            <h2 className="text-xs font-bold uppercase tracking-widest text-white bg-[#2f5986] px-3 py-1 rounded-full">Variation F - Different Style Dropdown Headers - No Left Column</h2>
          </div>
          <div className="mb-3 flex items-center gap-3">
            <h3 className="text-sm font-normal text-black">
