...
const NAV = [
  { label: 'Home', href: '/join-the-pack' },
  {
    ...
    sections: [
      ...
      {
        heading: 'Budget Forms & Instructions',
        href: '/its',
        links: [
          { label: 'Budget Amendments',    href: '/join-the-pack/future-students/program-specific-requirements/transfer-success-pathway-tsp' },
          { label: 'Position Management',          href: '/join-the-pack/future-students/program-specific-requirements/military-veteran-students' },
        ],
      },
      {
        heading: 'Campus Life',
